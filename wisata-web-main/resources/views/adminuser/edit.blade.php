    ...
    <div class="container py-5">
        <div class="form-container">
            ...
            @if ($errors->any())
                <div class="alert alert-danger alert-dismissible fade show">
                    <h5 class="alert-heading">
                        <i class="fas fa-exclamation-triangle me-2"></i>Gagal Mengupdate Data
                    </h5>
                    <ul class="mb-0">
            ...
            <div class="card shadow-sm border-0 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-4">
                        <div
                            class="user-avatar bg-primary text-white rounded-circle d-flex align-items-center justify-content-center me-4">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <span class="badge bg-light text-dark">
                            ...
                            Diupdate: {{ $user->updated_at->format('d M Y') }}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form action="{{ route('adminuser.update', $user->id) }}" method="POST" id="userForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="alert alert-info mb-4">
                            <i class="fas fa-info-circle me-2"></i>Biarkan kosong jika tidak ingin mengubah password
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger">Aksi ini tidak dapat dibatalkan dan semua data user akan dihapus permanen.
                    </p>
                </div>
                <div class="modal-footer">
                    ...
                    <form action="{{ route('adminuser.destroy', $user->id) }}" method="POST" class="d-inline">
                        @csrf
                        @method('DELETE')
