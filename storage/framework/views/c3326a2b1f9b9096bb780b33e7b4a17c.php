        ...
        <div class="flex-1 p-4 md:p-8">
            <div class="max-w-7xl mx-auto">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    ...
                    <a href="<?php echo e(route('wisata.create')); ?>"
                        ...
                        <div
                            ...
                            <?php if($wisata->gambar): ?>
                                <div class="h-48 overflow-hidden">
                                    <img src="<?php echo e(asset('storage/' . $wisata->gambar)); ?>"
                                        class="w-full h-full object-cover" alt="<?php echo e($wisata->title); ?>">
                                </div>
                            <?php else: ?>
                            ...
                            <div class="p-5">
                                <div class="flex justify-between items-start mb-2">
                                    <h3 class="text-lg font-semibold text-gray-800"><?php echo e($wisata->nama); ?></h3>
                                </div>

                                <p class="text-gray-600 text-sm mb-4 line-clamp-2"><?php echo e($wisata->deskripsi); ?></p>

                                <div class="flex items-center justify-between mb-4">
                                    <span class="text-sm text-gray-500">
                                        <i class="far fa-clock mr-1"></i>
                                        <?php echo e($wisata->created_at ? $wisata->created_at->translatedFormat('d M Y H:i') : 'N/A'); ?>

                                    </span>
                                </div>

                                <div class="flex space-x-2">
                                    <a href="<?php echo e(route('wisata.edit', $wisata)); ?>"
                                    ...
                                    <form action="<?php echo e(route('wisata.destroy', $wisata)); ?>" method="POST" class="flex-1">
                                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\wisata\resources\views/wisata/index.blade.php ENDPATH**/ ?>